...
# CONFIG
# ----------------------------------------------------------------------------
ROOT = PathROOT = Path('/home/rafy/yolov13/Paper_Hasil_Ujicoba/Dolphin14k_Hasil Percobaan')
...
WEIGHTS = {
    ...
    'yolov13_S1 + K5 + P2': ROOT / 'yolov13n_Semua Kombinasi_640/train124/weights/best.pt',
    'yolov13_Combined': ROOT / 'yolov13n_Semua Kombinasi_Partial Convolution juga_640/train230/weights/best.pt',
}
...
VAL_IMAGES_DIR = '/home/rafy/yolov13/dolphin14k/dataset/images/val2021'
VAL_LABELS_DIR = '/home/rafy/yolov13/dolphin14k/dataset/labels/val2021'
