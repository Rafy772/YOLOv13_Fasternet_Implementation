...
WEIGHTS = {
    ...
    'yolov13_Semua Perubahan':     ROOT / 'yolov13n_640_Semua Kombinasi_Partial Convolution/train235/weights/best.pt',
}

DATA        = 'ultralytics/cfg/datasets/TT100K.yaml'  # TT100K.yaml, lumba_lumba.yaml, visdrone2019.yaml
IMGSZ       = 640
BATCH       = 1
