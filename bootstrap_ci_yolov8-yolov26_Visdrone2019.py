...
# -------------------------------- config --------------------------------
MODELS = {
    'yolov13_fasternet': '/home/rafy/yolov13/Paper_Hasil_Ujicoba/Dolphin14k_Hasil Percobaan/yolov13_Partial Convolution_640/train186/weights/best.pt',
    'yolov13_baseline': '/home/rafy/yolov13/Paper_Hasil_Ujicoba/Dolphin14k_Hasil Percobaan/yolov13n_baseline_640/weights/best.pt',
 # 'Baseline':  '/path/to/baseline/weights/best.pt',
    # ...
}
DATA_YAML = 'ultralytics/cfg/datasets/lumba_lumba.yaml'  # val split is read from here

IMGSZ    = 640
CONF     = 0.01      # detections kept for the PR curve (0.01 vs val's 0.001 changes mAP <~0.002)
IOU_NMS  = 0.7
MAX_DET  = 300
DEVICE   = 'cpu'       # GPU 0  ('cpu' for CPU)
